...
/** @ingroup EXAMPLES_USBDROM_18XX43XX_MSC
 * @{
 */
...
uint8_t* g_memDiskArea = (uint8_t*)MSC_MEM_DISK_BASE;
...
/**
 * @brief	USB device mass storage class read callback routine
 * @return	Nothing
 */
...
/**
 * @brief	USB device mass storage class write callback routine
 * @return	Nothing
 */
...
/**
 * @brief	USB device mass storage class get write buffer callback routine
 * @return	Nothing
 */
...
/**
 * @brief	USB device mass storage class verify callback routine
 * @return	Nothing
 */
