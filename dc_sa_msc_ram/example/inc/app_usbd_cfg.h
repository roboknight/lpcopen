...
/* Comment this and uncomment USE_USB1 to enable USB 1 */
#define USE_USB0
/* #define USE_USB1 */
...
/* Manifest constants used by ROM stack. These values SHOULD NOT BE CHANGED
   for advance features which require usage of USB_CORE_CTRL_T structre.
   Since these are the values used for compileing USB stack in LPC18xx/43xx part.
 */
...
/* Manifest constants defining interface numbers and endpoints used by a
  prticular interface in this application.
 */
