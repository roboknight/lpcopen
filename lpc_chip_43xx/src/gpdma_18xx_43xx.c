...
static const uint8_t GPDMA_LUTPerBurst[] = {
	...
	GPDMA_BSIZE_1,	/* USART1 Tx          */
	GPDMA_BSIZE_1,	/* MAT1.1             */
	GPDMA_BSIZE_1,	/* USART1 Rx          */
...
static const uint8_t GPDMA_LUTPerWid[] = {
	...
	GPDMA_WIDTH_BYTE,	/* USART1 Tx          */
	GPDMA_WIDTH_WORD,	/* MAT1.1             */
	GPDMA_WIDTH_BYTE,	/* USART1 Rx          */
...
volatile static const void *GPDMA_LUTPerAddr[] = {
	...
	(&LPC_USART1-> /*RBTHDLR.*/ THR),/* USART1 Tx           */
	((uint32_t *) &LPC_TIMER1->MR + 1),	/* MAT1.1             */
	(&LPC_USART1-> /*RBTHDLR.*/ RBR),/* USART1 Rx           */
