...
#ifdef CORE_M4
static struct ipc_queue *qrd = (struct ipc_queue *)SHARED_MEM_M0;
static struct ipc_queue *qwr = (struct ipc_queue *)SHARED_MEM_M4;
...
static SemaphoreHandle_t event_tx, event_rx;
