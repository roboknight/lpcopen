...
#define M0_Image_Magic  0xAA55DEAD
extern const struct image_sig __M0Signature;
// *****************************************************************************
//
// The vector table.
...
void(*const g_pfnVectors[]) (void) = {
	...
	0,								// Reserved
    (void (*)(void))M0_Image_Magic, // M0 Image magic number
    (void (*)(void))&__M0Signature, // M0 Signature structure
	0,								// Reserved
